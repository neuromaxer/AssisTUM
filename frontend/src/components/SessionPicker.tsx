          ...
          {sessions.length === 0 ? (
            ...
            sessions.map((s) => (
              ...
              >
                ...
                {onDeleteSession && (
                  <button
                    className="text-ink-muted hover:text-danger w-6 h-6 flex items-center justify-center rounded-(--radius-sm) hover:bg-surface-hover transition-colors bg-transparent border-none cursor-pointer"
